...
<header class="h-8 w-10/12 left-1/2 z-50 -translate-x-1/2 top-0 fixed mt-6  select-none">
    <div class="w-full h-8 flex justify-between">
        <div class="bg-background rounded-lg">
            <a href="/" class="flex">
                <Icon size="2rem" stroke="#DBBE76" />
                <span class="inline-block ml-2 font-bold translate-y-1">Blog</span>
            </a>
        </div>
        <div class="bg-background rounded-lg">
            <div class="flex">
                <a class="mr-1" href="https://twitter.com/PurotoApp" target="_blank" aria-label="twitter" alt="twitter">
                ...
                <a class="ml-1 transition hover:text-[#6D6BED]" href="https://puroto.net/" target="_blank" aria-label="puroto.net" alt="puroto.net">
